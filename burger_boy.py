...
while True:
   if level == 1:
    ...
    if point < 0:
        ...
        draw_text ('5000 years ago man was challenged with the idea to eat 250 burgers in under 10 minutes.', font, screen, 5, 120)
        draw_text ('Your great great grandfather was the 18th to reach 200 burgers. By the time of his death everyone remembered', font, screen, 5, 140)
        draw_text ('him \'Alexander the Great\'. After his record of 214 burgers everyone was motivated to reach the big 250,',font, screen, 5, 160)
        draw_text ('but none were great enough. Then one day his daughter, Alice the Great, was able to eat', font, screen, 5, 180)
        draw_text ('219 burgers in under 10 minutes. After Alice, there were the brothers, George and Bob the Great,', font, screen, 5, 200)
        draw_text ('who were the new up and coming eaters. Competing, they were able to shatter their mother\'s record and ate', font, screen, 5, 220)
        draw_text ('233 burgers each in 10 minutes. Finally the day came and George passed away, after this Bob was sent into', font, screen, 5, 240)
        draw_text ('Burgerland which forced him to keep eating until he reached 1000 pounds. Bob was reincarnated 3 times', font, screen, 5, 260)
        draw_text ('before he was able to reach 1000 pounds, but the second he arrived back on Earth he was sent into a coma.', font, screen, 5, 280)
        draw_text ('While Bob was in a coma, George was reincarnated into a man named Thomas the Train, but he craved burgers,', font, screen, 5, 300)
        draw_text ('so much that a curse was put onto his family. The curse was that if he didn\'t eat burgers within a certain', font, screen, 5, 320)
        draw_text ('amount of time he would lose size and weight. Thomas (George) kept eating burgers until he died,', font, screen, 5, 340)
        draw_text ('but in 10 minutes he still only could eat 243 burgers. His son, your father, was always the fatest kid', font, screen, 5, 360)
        draw_text ('growing up because of his weird desease that the doctors were calling... \'NoBurgerPhobiaOfEpicProportions\'', font, screen, 5, 380)
        draw_text ('he had to constantly eat burgers, but one day he couldn\'t take it anymore and ate cookies instead.', font, screen, 5, 400)
        draw_text ('It was a painful death, but the Burger Gods were not pleased with his change of heart and chose for his legacy', font, screen, 5, 420)
        draw_text ('to come to Burgerland.Just as Bob did, you have to reach the goal that your predecessors couldn\'t reach,', font, screen, 5, 440)
        draw_text ('250 burgers in under 10 minutes.This is Your Job, the Burger Gods decided that if you were able to eat', font, screen, 5, 460)
        draw_text ('250 burgers in under 10 minutes you could leave. And they have told your previous incarnates that you could', font, screen, 5, 480)
        draw_text ('also break the curse of the need for burger meat. You could break the record and you could be remembered as', font, screen, 5, 500)
        draw_text ('the Greatest Burger Eater ever. Some day you will do it, but today is not that day. Goodbye... You Lose!', font, screen, 5, 520)
###############################
    if point >= 100 and level == 1:
        ...
        draw_text ('\'My 1000 Pound Life\' Was Hysterical as people watched you roll around eating burgers', font, screen, 200, 550)
